...
function QuickApplyLeave({ user }) {
  ...
  useEffect(() => {
    const fetchManager = async () => {
      ...
      try {
        const res = await axios.get(
          ` https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/users/${user.reportingManager}`
        );
        setManager(res.data);
      } catch (err) {
  ...
  return (
    ...
    <div className="card mt-3 shadow-sm h-100 border-0">
      ...
      <div className="ms-4">
        ...
        <button className="btn" style={{ float: "right", marginRight: "25px",backgroundColor: "#3A5FBE", color: "white" }} onClick={handleApplyClick}>
          Apply
        </button>
      </div>
              ...
              <div className="modal-body">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit"
                      className="btn" style={{ backgroundColor: "#3A5FBE", color: "white", border: "none", padding: "10px 32px", fontSize: "14px", fontWeight: "500", borderRadius: "4px" }} >
                      Apply
                    </button>
                  </div>
                </form>
