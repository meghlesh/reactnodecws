...
//           ` https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/employee/verify/${id}/${token}`
//         );
...
//         ` https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/employee/set-password`,
//         { id, token, password }
//       );
