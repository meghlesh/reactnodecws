...
setMessage("");
    ...
    try {
      ...
      const res = await axios.post(" https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/admin/add-employee", payload, {
...
// ✅ Show success alert after submission
  ...
  return (
    ...
    <>
      <button className="btn  btn-sm" style={{ backgroundColor: "#3A5FBE", borderColor: "#3A5FBE", color: "#fff" }} onClick={() => setShowModal(true)}>
        Add Employee
      </button>
      {showModal && (
