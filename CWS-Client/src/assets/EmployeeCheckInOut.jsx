...
function EmployeeCheckInOut({ employeeId }) {
  ...
  useEffect(() => {
    ...
    axios
      .get(` https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/attendance/today/${employeeId}`, {
  ...
  const handleCheckIn = async () => {
    const res = await axios.post(
      ` https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/attendance/checkin/${employeeId}`,
      {},
      { headers: { Authorization: `Bearer ${token}` } }
    );
    setAttendance(res.data);
  ...
  const handleCheckOut = async () => {
    const res = await axios.post(
      ` https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/attendance/checkout/${employeeId}`,
      {},
      { headers: { Authorization: `Bearer ${token}` } }
    );
    setAttendance(res.data);
