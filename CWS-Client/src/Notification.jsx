...
function Notification({ userId }) {
  ...
  const handleNotificationClick = async (n) => {
    try {
      ...
      await axios.put(`https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/notifications/${n._id}/read`);
    ...
    const fetchNotifications = async () => {
      try {
        const res = await axios.get(
          `https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/notifications/${userId}`
        );
