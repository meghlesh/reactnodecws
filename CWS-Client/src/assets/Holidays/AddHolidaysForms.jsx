...
function AddHolidayForm({ onAdd }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        " https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/holidays",
        { name, date },
  ...
  return (
    <>
      ...
      <button
        className="btn btn-sm " style={{ backgroundColor: "#3A5FBE", borderColor: "#3A5FBE", color: "#fff" }}
              ...
              <div className="custom-modal-body">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="custom-modal-footer">
                    ...
                    <button
                      className="btn" style={{ backgroundColor: "#3A5FBE", borderColor: "#3A5FBE", color: "white" }}
                      type="submit"
                      disabled={loading}
                    >
