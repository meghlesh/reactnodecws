...
//   useEffect(() => {
//     axios
//       .get(" https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/admin/office-location")
//       .then((res) => {
...
//   setLoading(true);
//   try {
//     await axios.post("https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/admin/office-location", location);
...
function OfficeLocationSetup() {
  ...
  const handleSave = () => {
    ...
    axios
      .post("https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/admin/office-location", editLocation)
      .then(() => {
      ...
      <div className="card shadow-sm mb-4 border-0">
        <div className="card-body">
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <button className="btn btn-primary btn-sm px-4" onClick={openModal}>
              Edit
            </button>
          </div>
            ...
            >
              <div className="modal-dialog">
                <div className="modal-content border-0 shadow-lg">
                  ...
                  <div className="modal-footer">
                    <button className="btn" style={{ backgroundColor: "#3A5FBE", color: "#fff" }} onClick={useCurrentLocation}>
                      Use Current Location
                    </button>

                    <button className="btn" style={{ backgroundColor: "#3A5FBE", color: "#fff" }} onClick={handleSave}>
                      {loading ? "Saving..." : "Save changes"}
                    </button>

                    <button
                      className="btn btn-outline" style={{ borderColor: "#3A5FBE", color: "#3A5FBE" }}
                      onClick={() => setShowModal(false)}
                    >
                      Close
                    </button>
