    ...
    if (!stateEmployee) {
      const fetchEmployee = async () => {
        try {
          ...
          const res = await axios.get(` https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/getEmployee/${empId}`, {
...
// 🧩 Contact validation — must be exactly 10 digits
  ...
  if ((currentZip && !/^\d{6}$/.test(currentZip)) || (permanentZip && !/^\d{6}$/.test(permanentZip))) {
    ...
    try {
      ...
      await axios.put(` https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/employees/${employee._id || empId}`, data, {
      ...
      const updated = await axios.get(` https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/getEmployee/${employee._id || empId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
              ...
              {isEditing ? (
                <div className="d-flex flex-column align-items-center text-center">
                  ...
                  {formData.image instanceof File ? (
                    ...
                    <img
                      //src={` https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/image/${employee.image}`}
                      src={
                        employee?.image?.startsWith("http")
                          ? employee.image
                          : `https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/uploads/${employee.image}`
                      }
      ...
      {formData.image instanceof File ? (
        ...
        <div>
          <div className="card-body">
            ...
            field === "email" ? "bg-secondary-subtle text-muted" : "bg-light"
          }`}
                      ...
                      <div
                        className="form-control bg-light border-0"
                        style={{     textTransform: field === "email" ? "none" : "capitalize", // ✅ don't capitalize email
 }}
                      >
                        {employee[field] || "-"}
                      </div>
            ...
            <div className="d-flex gap-3 flex-wrap">
              {["aadharCardPdf", "panCardPdf", "appointmentLetter"].map((field) => (
                <div key={field} className="d-flex flex-column align-items-center">
                  ...
                  {isEditing ? (
                    ...
                    <a
                      // href={` https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/uploads/${employee[field]}`}
                      href={
                        employee[field]?.startsWith("http")
                          ? employee[field]
                          : `https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/uploads/${employee[field]}`
                      }
                      target="_blank"
              ...
              <div className="d-flex flex-column align-items-center">
                ...
                {isEditing ? (
                  ...
                  <a
                    href={`https://api-nodelinux-be-b8cpf8cbe8f4f5b0.centralus-01.azurewebsites.net/uploads/${employee.bankDetails.passbookPdf}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
            ...
            {/* Leaves & Salary */}
            <h6 className="mt-3">Leaves & Salary</h6>
            <div className="row g-3">
